========================================================================
    ACTIVE TEMPLATE LIBRARY : ReportPhishing Project Overview
========================================================================

AppWizard has created this ReportPhishing project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ReportPhishing.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ReportPhishing.vcxproj.filters
...
ReportPhishing.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ReportPhishing.h)
        GUID definitions                                (ReportPhishing_i.c)
        A type library                                  (ReportPhishing.tlb)
        Marshaling code                                 (ReportPhishing_p.c and dlldata.c)

ReportPhishing.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ReportPhishing.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ReportPhishing.pch and a precompiled types file named StdAfx.obj.
...
ReportPhishingps.vcxproj
	...
	dlldata.c, ReportPhishing_i.c and ReportPhishing_p.c which are required
	to build the proxy/stub DLL.

ReportPhishingps.vcxproj.filters
